...
ActiveRecord::Schema.define(version: 20180227171752) do
  ...
  create_table "movie_awards", force: :cascade do |t|
    t.bigint "movie_id"
    t.bigint "awards_id"
    t.index ["awards_id"], name: "index_movie_awards_on_awards_id"
  ...
  add_foreign_key "movie_awards", "awards", column: "awards_id"
